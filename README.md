...
| `enable full project access` | Grants local repo file read/write/test/commit permission for the current session without repeated file-access confirmations |
